...
public class AreaListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.content_layout = (ImageView) convertView
        ...
        holder.tv_name.setText(appInfo.getAddress());
        String imgPath = appInfo.getImg();
        Instance.imageLoader.displayImage(imgPath, holder.content_layout, Instance.user_s_options);
